# Fetch actual Square subscription plan IDs from your account

Write-Host "🔍 Fetching your Square subscription plans..." -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    if ($response.objects) {
        ...
        Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor DarkGray
        Write-Host ""
        Write-Host "⚠️  Compare the IDs above with what you used:" -ForegroundColor Yellow
